...
# Page Config 
st.set_page_config(
    page_title="Assignment Grader Project",
    page_icon="📝",
    layout="wide"
...
st.sidebar.info(
    ...
    Upload assignments in PDF or Docx format,set your grading rubric and get instant AI-powered grades
...
with st.sidebar.expander("API Configuration"):
    ...
    google_key = st.text_input("Google API Key", type="password", help="Enter your Google API key")
    google_cx = st.text_input("Google Custom Search Engine ID",type="password",help="Enter your Google Custom Search Engine ID")
